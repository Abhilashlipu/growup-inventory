...
class UnitRepo {
  ...
  Future<Response> getUnitList(int offset) async {
    return await apiClient
        .getData('${AppConstants.GET_UNIT_LIST}?limit=10&offset=$offset');
  }

  Future<Response> deleteUnit(int unitId) async {
    return await apiClient
        .getData('${AppConstants.DELETE_UNIT_URI}?id=$unitId  ');
  }
  ...
  Future<Response> addUnit(String unitType, int unitId,
    ...
    return await apiClient.postData(
        isUpdate
            ? '${AppConstants.UPDATE_UNIT_URI}'
            : '${AppConstants.ADD_UNIT}',
        {
          'id': unitId,
          'unit_type': unitType,
