...
import 'package:grow_up/view/screens/account_management/widget/transaction_list_card_widget.dart';
      ...
      if (scrollController.position.maxScrollExtent ==
        ...
        if (offset < pageSize && !isHome) {
          ...
          Get.find<TransactionController>()
              .getCustomerWiseTransactionListList(customerId, offset);
        }
      }
    });
