...
import 'package:grow_up/view/screens/account_management/widget/customer_transaction_list_view.dart';
import 'package:grow_up/view/screens/account_management/widget/transaction_list_view.dart';
  ...
  void initState() {
    ...
    if (widget.fromCustomer) {
      Get.find<TransactionController>()
          .getCustomerWiseTransactionListList(widget.customerId, 1);
    } else {
                          ...
                          Row(
                            children: [
                              ...
                              Expanded(
                                child: InkWell(
                                  onTap: () {
                                    String startDate = transactionController
                                        .startDate
                                        .toString();
                                    String endDate = transactionController
                                        .endDate
                                        .toString();
