...
import 'package:grow_up/view/base/custom_search_field.dart';
import 'package:grow_up/view/screens/account_management/widget/expense_list_view.dart';
import 'package:grow_up/view/screens/account_management/widget/income_list_view.dart';
                                  ...
                                  child: CustomDatePicker(
                                    ...
                                    text: expenseController.startDate != null
                                        ? expenseController.dateFormat
                                            .format(expenseController.startDate)
                                            .toString()
                                        : 'from_date'.tr,
                                ...
                                InkWell(
                                  onTap: () {
                                    if (widget.isIncome) {
                                      ...
                                      print(
                                          '=======Expense filter==>${expenseController.dateFormat.format(expenseController.startDate).toString()}');
