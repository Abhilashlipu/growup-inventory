...
import 'package:grow_up/view/base/custom_date_picker.dart';
import 'package:grow_up/view/base/custom_drawer.dart';
import 'package:grow_up/view/base/custom_header.dart';
import 'package:grow_up/view/base/secondary_header_view.dart';
import 'package:grow_up/view/screens/user/widget/supplier_new_purchase_dialog.dart';
import 'package:grow_up/view/screens/user/widget/supplier_transaction_list.dart';
              ...
              SliverToBoxAdapter(
                child: Column(children: [
                  CustomHeader(
                      ...
                      headerImage: Images.people_icon),
                        ...
                        children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  supplierController.supplierProfile != null
                                      ? Text(
                                          '${PriceConverter.priceWithSymbol(supplierController.supplierProfile.dueAmount ?? 0)}',
                          ...
                          Padding(
                            padding: const EdgeInsets.fromLTRB(
                                0, 0, Dimensions.PADDING_SIZE_DEFAULT, 0),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                InkWell(
