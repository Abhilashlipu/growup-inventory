...
class _AddNewSuppliersOrCustomerState extends State<AddNewSuppliersOrCustomer> {
  ...
  bool customerUpdate, supplierUpdate;
  @override
  void initState() {
    super.initState();
                                ...
                                child: customerController.customerImage != null
                                    ...
                                    : widget.customer != null
                                        ? FadeInImage.assetNetwork(
                                            ...
                                            image:
                                                '${'https://test.6am.one/6pos/storage/app/public/customer'}/${widget.customer.image != null ? widget.customer.image : ''}',
                                            height: 120,
                                            width: 150,
                                            fit: BoxFit.cover,
                        ...
                        child: Stack(children: [
                          ClipRRect(
                            ...
                            child: supplierController.supplierImage != null
                                ? Image.file(
                                    File(supplierController.supplierImage.path),
                                    width: 150,
                                    height: 120,
                                    fit: BoxFit.cover,
                                  )
                                : widget.supplier != null
                                    ? FadeInImage.assetNetwork(
                                        placeholder: Images.placeholder,
                                        image:
                                            '${Get.find<SplashController>().baseUrls.supplierImageUrl}/${widget.supplier.image != null ? widget.supplier.image : ''}',
                                        height: 120,
                                        width: 150,
                                        fit: BoxFit.cover,
                                        imageErrorBuilder: (c, o, s) =>
