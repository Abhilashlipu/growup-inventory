...
import 'package:grow_up/view/base/custom_image.dart';
import 'package:grow_up/view/base/custom_ink_well.dart';
import 'package:grow_up/view/base/logout_dialog.dart';
import 'package:grow_up/view/screens/account_management/transaction_list_screen.dart';
...
import 'package:grow_up/view/screens/user/widget/add_balance_dialog.dart';
import 'package:grow_up/view/screens/user/widget/custom_divider.dart';
          ...
          child:
            ...
            Row(
              children: [
                CustomImage(
                  image:
                      '${'https://test.6am.one/6pos/storage/app/public/customer'}/${customer.image}',
                  width: 50,
                  height: 50,
                  fit: BoxFit.cover,
                  placeholder: Images.profile_place_holder,
                ),
                ...
                customer.id == 0
                    ...
                    : Padding(
                        ...
                        child: CustomInkWell(
                          child: Image.asset(Images.edit_icon, height: 30),
                          onTap: () {
                ...
                customer.id == 0
                    ...
                    : GetBuilder<CustomerController>(
                        ...
                        return CustomInkWell(
                          child: Image.asset(Images.delete_icon, height: 30),
                          onTap: () {
                            showAnimatedDialog(
                                context,
                                CustomDialog(
