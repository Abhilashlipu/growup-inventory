...
import 'package:grow_up/data/model/body/place_order_body.dart';
import 'package:grow_up/data/model/response/account_model.dart';
import 'package:grow_up/data/model/response/cart_model.dart';
import 'package:grow_up/data/model/response/temporary_cart_for_customer.dart'
    as customer;
import 'package:grow_up/helper/price_converter.dart';
...
import 'package:grow_up/view/base/animated_custom_dialog.dart';
import 'package:grow_up/view/base/custom_app_bar.dart';
import 'package:grow_up/view/base/custom_button.dart';
import 'package:grow_up/view/base/custom_divider.dart';
import 'package:grow_up/view/base/custom_header.dart';
import 'package:grow_up/view/base/custom_snackbar.dart';
import 'package:grow_up/view/base/custom_text_field.dart';
import 'package:grow_up/view/screens/pos/widget/cart_pricing_widget.dart';
import 'package:grow_up/view/screens/pos/widget/confirm_purchase_dialog.dart';
import 'package:grow_up/view/screens/pos/widget/coupon_apply_widget.dart';
import 'package:grow_up/view/screens/pos/widget/customer_search_dialog.dart';
import 'package:grow_up/view/screens/pos/widget/extra_discount_and_coupon_dialog.dart';
import 'package:grow_up/view/screens/pos/widget/item_card_widget.dart';
                ...
                return Column(
                  children: [
                    CustomHeader(
                        ...
                        headerImage: Images.billing_section),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      child: DropdownButton<int>(
                                        value:
                                            accountController.fromAccountIndex,
                                                                    ...
                                                                    carts.add(
                                                                      ...
                                                                      cart.product.discountType ==
                                                                          ...
                                                                          ? productDiscount + cart.product.discount ??
                                                                              0
                                                                          : productDiscount +
                                                                              ((cart.product.discount / 100) * cart.product.sellingPrice),
                                                                      cart.quantity,
                                                                      productTax +
                                                                          ((cart.product.tax / 100) *
