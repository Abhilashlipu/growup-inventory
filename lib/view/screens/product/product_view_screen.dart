...
import 'package:grow_up/view/screens/product/widget/product_list_view.dart';
import 'package:grow_up/view/screens/product/widget/supplier_product_list.dart';
  ...
  void initState() {
    ...
    if (widget.isSupplier) {
      Get.find<SupplierController>()
          .getSupplierProductList(1, widget.supplierId, reload: true);
    } else {
