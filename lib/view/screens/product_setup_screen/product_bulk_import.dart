                                ...
                                children: [
                                  Text('download_format'.tr,
                                      style: fontSizeRegular.copyWith(
                                          color:
                                              ColorResources.DOWNLOAD_FORMAT)),
                                  SizedBox(
                                      width: Dimensions.PADDING_SIZE_SMALL),
                                  Container(
                                      child:
                                          Image.asset(Images.download_format),
                                      width: Dimensions.ICON_SIZE_SMALL),
                                ],
                              ),
                            ),
                ...
                InkWell(
                  ...
                  child: Builder(builder: (context) {
                    ...
                    return Column(
                      ...
                      children: [
                        Container(
                            width: 100, child: Image.asset(Images.upload)),
                        importController.selectedFileForImport != null
                            ? Text(
                                '${'product_bulk_format.xlsx'}',
                                style: fontSizeRegular.copyWith(
                                    color: ColorResources.DOWNLOAD_FORMAT
                                        .withOpacity(.5)),
                              )
                            : Text(
                                'upload_file'.tr,
