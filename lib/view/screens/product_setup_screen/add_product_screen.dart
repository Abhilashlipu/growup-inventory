...
import 'package:grow_up/view/screens/product_setup_screen/widget/product_general_info.dart';
import 'package:grow_up/view/screens/product_setup_screen/widget/product_price_info.dart';
...
class _AddProductScreenState extends State<AddProductScreen>
  ...
  Future<void> _loadData() async {
    Get.find<CategoryController>()
        .getCategoryList(1, product: widget.product, reload: true);
    Get.find<BrandController>()
        .getBrandList(1, product: widget.product, reload: true);
    Get.find<UnitController>().getUnitList(1, product: widget.product);
    Get.find<SupplierController>()
        .getSupplierList(1, product: widget.product, reload: true);
  }
  ...
  void initState() {
    ...
    if (update) {
      _loadData();
      Get.find<ProductController>().productSellingPriceController.text =
          widget.product.sellingPrice.toString();
      Get.find<ProductController>().productPurchasePriceController.text =
          widget.product.purchasePrice.toString();
      Get.find<ProductController>().productTaxController.text =
          widget.product.tax.toString();
      Get.find<ProductController>().productDiscountController.text =
          widget.product.discount.toString();
      Get.find<ProductController>().productSkuController.text =
          widget.product.productCode;
      Get.find<ProductController>().productStockController.text =
          widget.product.quantity.toString();
      Get.find<ProductController>().productNameController.text =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(children: [
        CustomHeader(
            title: 'add_product'.tr, headerImage: Images.add_new_category),
        Center(
          child: Container(
            width: 1170,
                        ...
                        child: CustomButton(
                          ...
                          onPressed: () {
                            ...
                            String discount = productController
                                ...
                                .trim();
                            String categoryId = categoryController
                                .categoryList[
                            ...
                            String productCode = productController
                                ...
                                .trim();
                            String productQuantity = productController
