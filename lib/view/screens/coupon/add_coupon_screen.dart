        ...
        builder: (couponController) => Column(
          children: [
            CustomHeader(
                ...
                headerImage: Images.coupon_list_icon),
            ...
            couponController.isAdded
                ...
                : CustomButton(
                    ...
                    onPressed: () {
                      ...
                      String startDate = update
                          ? widget.coupon.startDate
                          : couponController.dateFormat
                              .format(couponController.startDate)
                              .toString();
                      String endDate = update
                          ? widget.coupon.expireDate
                          : couponController.dateFormat
                              .format(couponController.endDate)
                              .toString();
                      ...
                      bool compare = couponController.startDate
