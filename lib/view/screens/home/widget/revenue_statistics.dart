        ...
        return Column(
          children: [
                  ...
                  child: DropdownButton<String>(
                    value: revenueController.revenueFilterTypeIndex == 0
                        ...
                        : revenueController.revenueFilterTypeIndex == 1
                            ? 'Today'
                            : 'This Month',
                    items: <String>['Overall', 'Today', 'This Month']
                        .map((String value) {
            ...
            revenueController.revenueModel != null
                ? Container(
                    height: Dimensions.REVENUE_CARD,
                    child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Padding(
                            ...
                            child: Container(
                              padding:
                                  EdgeInsets.all(Dimensions.PADDING_SIZE_CARD),
                              width: Dimensions.DASHBOARD_CARD_WIDTH,
                              height: Dimensions.REVENUE_CARD,
                              decoration: BoxDecoration(
                                ...
                                children: [
                                  Positioned(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          '${PriceConverter.priceWithSymbol(double.parse(_itemsAmount[index]))}',
                                          maxLines: 2,
