                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            SizedBox(width: 30,),
                            Text("Welcome to",style: TextStyle(fontSize: 30,color: Colors.indigo,fontWeight: FontWeight.bold),),

                            SizedBox(width: 10,),

                            Text("Grow Up",style: TextStyle(fontSize: 30,color: Colors.amber[900],fontWeight: FontWeight.bold),),
                          ],
                        ),
                        SizedBox(height: 20,),
                        Text("Inventory System ",style: TextStyle(fontSize: 30,color: Colors.indigo,fontWeight: FontWeight.bold),),

                        SizedBox(height: 20,),
                        Text("By",style: TextStyle(fontSize: 30,color: Colors.indigo,fontWeight: FontWeight.bold),),

                        SizedBox(height: 20,),
                        Text("Abhilash Jena ",style: TextStyle(fontSize: 30,color: Colors.amber[900],fontWeight: FontWeight.bold),),
