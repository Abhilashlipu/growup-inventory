...
import 'package:grow_up/view/base/custom_field_with_title.dart';
...
class _InfoFieldVIewState extends State<InfoFieldVIew> {
  ...
  void initState() {
    ...
    Get.find<SplashController>()
        .setValueForSelectedTimeZone(widget.configModel.businessInfo.timeZone);
  ...
  Widget build(BuildContext context) {
    return GetBuilder<SplashController>(builder: (shopController) {
      return Column(
        children: [
          Expanded(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              hint: shopController.selectedTimeZone == null
                                  ? Text('select'.tr)
                                  : Text(
                                      shopController.selectedTimeZone,
                                      style: fontSizeRegular.copyWith(
                                          color: ColorResources.getTextColor()),
                                    ),
                              items:
                                  shopController.timeZone.map((String value) {
                      ...
                      child: Align(
                          ...
                          child: Stack(children: [
                            ClipRRect(
                              ...
                              child: shopController.shopLogo != null
                                  ? Image.file(
                                      File(shopController.shopLogo.path),
                                      width: 150,
                                      height: 120,
                                      fit: BoxFit.cover,
                                    )
                                  : widget.configModel.businessInfo.shopLogo !=
                                          null
                                      ? FadeInImage.assetNetwork(
                                          placeholder: Images.placeholder,
                                          image:
                                              '${Get.find<SplashController>().baseUrls.shopImageUrl}/${widget.configModel.businessInfo.shopLogo != null ? widget.configModel.businessInfo.shopLogo : ''}',
                                          height: 120,
                                          width: 150,
                                          fit: BoxFit.cover,
          ...
          Padding(
            ...
            child: CustomButton(
              buttonText:
                  shopController.isLoading ? 'updating......'.tr : 'update'.tr,
              onPressed: () {
