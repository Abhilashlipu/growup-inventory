...
import 'package:grow_up/data/model/response/sub_category_model.dart';
...
import 'package:grow_up/view/screens/category/widget/add_new_sub_category.dart';
...
class SubCategoryCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding:
          const EdgeInsets.symmetric(vertical: Dimensions.PADDING_SIZE_BORDER),
      child: Container(
        height: 70,
