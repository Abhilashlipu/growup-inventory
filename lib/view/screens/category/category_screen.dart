...
import 'package:grow_up/view/screens/category/category_list_view_screen.dart';
import 'package:grow_up/view/screens/category/sub_category_list_screen.dart';
      ...
      body: Column(
        children: [
          CustomCategoryButton(
            ...
            isDrawer: false,
            padding: width,
            onTap: () => Get.to(CategoryListViewScreen()),
          ),
          CustomCategoryButton(
              ...
              padding: width,
              isDrawer: false,
              onTap: () => Get.to(SubCategoryListViewScreen())),
        ],
      ),
    );
  }
